...
- If the prompt use terms like latest, the ultimate, the fresh (refering to latest features) it means that isRangeInPrompt must be true and and the startDate must be the date from the past 4 weeks and the endDate must be the current date.
