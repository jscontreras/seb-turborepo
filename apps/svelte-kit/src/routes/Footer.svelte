<footer>
  ...
  <p class="details">
    Built with <a target="_blank" rel="noreferrer" href="https://kit.svelte.dev"
      >SvelteKit</a
    >
    +
    <a
  ...
  <p class="source">
    ...
    <a
      target="_blank"
      rel="noreferrer"
      href="https://github.com/vercel/examples/blob/main/toolbar/toolbar-feature-flags-sveltekit"
    >
      Source
    </a>
  </p>
