...
export async function POST(req: Request) {
  ...
  const systemPrompt = shouldContinue
    ...
    : "You are a helpful assistant that can echo messages with a timestamp and analyze images. Use the echo tool when asked to echo something. When the user uploads an image, describe what you see in detail."
